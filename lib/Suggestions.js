...
class Suggestions extends React.Component {
  ...
  render() {
    if (!this.props.expanded || !this.props.options.length) {
      return (
        <div style={{ height: 350, overflowY: 'visible' }} hidden className={this.props.classNames.suggestions}>
          <ul hidden role='listbox' id={this.props.id}>Qualquer coisa</ul>
        </div>
      )
    }
    ...
    return (
      <div style={{ height: 350, overflowY: 'visible', zIndex: 10 }} className={this.props.classNames.suggestions}>
